...
public class DeliveredFragment extends Fragment {
    View view;
    ListView lvDeliveredList;
    int tab = 1;
    // here created a context object and assigning it value onAttach()
    Context context;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        lvDeliveredList = view.findViewById(R.id.lvDeliveredList);
        ProductDB productDB = new ProductDB(context);
        productDB.open();
        ArrayList<Product> products = productDB.fetchDelieveredProducts();
        productDB.close();
        ProductAdapter adapter = new ProductAdapter(context, R.layout.product_item_design, products,tab);
        lvDeliveredList.setAdapter(adapter);
    }
    @Override
